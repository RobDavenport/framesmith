...
def main():
    ...
    dirty = bool(subprocess.check_output(['git', 'status', '--porcelain', '--', 'demo-wasm', 'crates/framesmith-runtime', 'crates/framesmith-fspack', 'src-tauri'], cwd=ROOT, text=True).strip())
